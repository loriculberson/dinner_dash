...
Item.create(title: "Molten Lava Cake", description: "Chocolatley goodness oozing out of the volanic center.", price: 800, item_status_id: 1)
...
Item.create(title: "Surf and Turf", description: "Delmonico steak, porterhouse, prime rib or New York strip accompanied by fresh Maine lobster. ", price: 4800, item_status_id: 2)
Item.create(title: "Calamari Salad", description: "A light refreshing seafood salad made with squid, fresh lemon, celery, red onion, roasted peppers, garlic and parsley.. ", price: 1300, item_status_id: 1)
