...
Item.create(title: "Assorted Canoli", description: "Yummy little tube-shaped shells of fried pastry dough, filled with a sweet, creamy filling.", price: 700, item_status_id: 2)
Item.create(title: "Molten Lava Cake", description: "Yummy little tube-shaped shells of fried pastry dough, filled with a sweet, creamy filling.", price: 800, item_status_id: 1)
Item.create(title: "Pomegranate Tort", description: "Filled with buttercream and mousse, this is one savory torte.", price: 900, item_status_id: 1)
Item.create(title: "Rapsberry Cheesecake", description: "Raspberry sauce is swirled into the batter of a creamy white chocolatecheesecake. Garnish with white chocolate curls if desired..", price: 500, item_status_id: 1)

Item.create(title: "Blackenend Swordfish", description: "Freshly caught and flown  in, this fish is tasty as well as a healthy choice", price: 2350, item_status_id: 1)
Item.create(title: "Grilled Platter", description: "Seafood platter with fresh lobster, shrimp, oysters and more. Enough for several people to share..", price: 2100, item_status_id: 1)
Item.create(title: "Prawn Delight", description: "Grandiose shrimp served with grilled garlic and butter sauce.", price: 1350, item_status_id: 1)
Item.create(title: "Steamer Clams", description: "So simple, but so good - steamed clams served in their own liqueur. Serve with a crusty Italian bread, or over pasta.", price: 1900, item_status_id: 1)
Item.create(title: "Stuffed Flounder", description: "A fresh flounder filet, packed full of crab meat and seasonings cooked to perfection.", price: 2650, item_status_id: 1)
Item.create(title: "Stuffed Lobster", description: "Fresh from Maine and bathed in butter, this is stuffed lobster is our most popluar dish.", price: 3895, item_status_id: 1)
Item.create(title: "Surf and Turf", description: "Fresh from Maine, this lobster tail with your choice of filet, Delmonico steak, porterhouse, prime rib or New York strip. ", price: 4800, item_status_id: 2)

Item.create(title: "Calamari Salad", description: "Fresh from Maine, this lobster tail with your choice of filet, Delmonico steak, porterhouse, prime rib or New York strip. ", price: 1300, item_status_id: 1)
Item.create(title: "Scallops with Edamame", description: "Pan seared scallops tossed in an edamame ", price: 1200, item_status_id: 1)
Item.create(title: "Grilled Salmon Salad", description: "Savory Salmon Salad mixed with fresh parsley, green onions and a citruis vinegrette", price: 1200, item_status_id: 1)
Item.create(title: "Thai Shrimp Salad", description: "A delicious blend of garden fresh vegetables, tossed in a chili lime vinaigrette and topped with juicy shrimp, wonton strips, peanut sauce and fresh cilantro", price: 1200, item_status_id: 1)
